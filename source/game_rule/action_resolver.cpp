...
{    
    switch (input)
    {
        case Action::DROP: return {curr_r + 1, curr_c, curr_rot};
        case Action::LEFT: return {curr_r, curr_c - 1, curr_rot};
        case Action::RIGHT: return {curr_r, curr_c + 1, curr_rot};
        default: return {curr_r, curr_c, curr_rot};
    }
}

vector<Pose> ActionResolver::resolve_rotation(int curr_r, int curr_c, int curr_rot, int mino_type, int input, bool enable_kick)
{
