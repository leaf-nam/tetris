...
// C#(WPF)의 콜백함수 등록
DLL_EXPORT void
register_callbacks(InputScanCallback scan_callback, RenderBackgroundCallback background_callback,
                   RenderBoardCallback board_callback, RenderHoldCallback hold_callback,
                   RenderNextBlockCallback next_callback, RenderTimerCallback timer_callback,
                   RenderScoreCallback score_callback, RenderLevelCallback level_callback,
...
DLL_EXPORT void stop_engine() { game_engine->stop(); }
