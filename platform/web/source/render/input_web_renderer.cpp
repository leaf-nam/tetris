#include "render/input_web_renderer.hpp"

using namespace std;

InputWebRenderer::InputWebRenderer(ConsoleRenderer a1, BoxRenderer a2)
    : console_renderer(a1), box_renderer(a2) {};

void InputWebRenderer::render_input_web(Pos pos, string message)
{
    int w = 40;
    int h = 5;
