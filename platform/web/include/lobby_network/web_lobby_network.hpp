#ifndef __WEB_LOBBY_NETWORK_HPP__
#define __WEB_LOBBY_NETWORK_HPP__

#include "i_lobby_network.hpp"

class WebLobbyNetwork final : public ILobbyNetwork
{
  private:
  ...
  public:
    ...
    void send_udp(const char* room_master_id,
    ...
    ~WebLobbyNetwork() override = default;
};
