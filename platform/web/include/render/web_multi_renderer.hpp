#ifndef __WEB_MULTI_RENDERER_H__
#define __WEB_MULTI_RENDERER_H__
...
#include "input_web_renderer.hpp"
#include "pos.hpp"
...
class WebMultiRenderer : public IRenderer
{
  private:
    Setting* setting;
  ...
  public:
    WebMultiRenderer(Setting*, ConsoleRenderer, ColorPicker, TextRenderer, BoxRenderer,
     ...
     * @brief 소멸자
     */
    virtual ~WebMultiRenderer() override;
