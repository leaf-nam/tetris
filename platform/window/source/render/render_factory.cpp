...
{
    return MenuRenderer(setting, platform_renderer, create_text_renderer(),
                        create_block_renderer());
}
...
{
    return WindowMultiRenderer(setting, platform_renderer, color_picker, create_text_renderer(),
                               create_box_renderer(), create_block_renderer(), shadow_maker);
}
