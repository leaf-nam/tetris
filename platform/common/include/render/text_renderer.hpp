...
class TextRenderer
{
  ...
  public:
    ...
    void print_big_string(Pos, const std::string&, Color);
    void print_big_string(Pos, const std::string&, Color foreground, Color background);
    void print_big_string(Pos, const std::string&);
    void print_big_string(Pos pos, const char* str, Color key);
    void print_big_string(Pos, const char*);
    void print_small_string(Pos, const std::string&, Color);
    void print_small_string(Pos, const std::string&);
